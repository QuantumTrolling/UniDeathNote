...
public class SkilllsScreen extends AbstractContainerScreen<SkilllsMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 102 && mouseX < leftPos + 126 && mouseY > topPos + 94 && mouseY < topPos + 118)
		...
		if (mouseX > leftPos + 43 && mouseX < leftPos + 67 && mouseY > topPos + 94 && mouseY < topPos + 118)
	...
	public void init() {
		...
		imagebutton_1ghostly_hunger2 = new ImageButton(this.leftPos + 105, this.topPos + 98, 16, 16, 0, 0, 16, new ResourceLocation("deathnote:textures/screens/atlas/imagebutton_1ghostly_hunger2.png"), 16, 32, e -> {
			if (true) {
		...
		imagebutton_6obsession = new ImageButton(this.leftPos + 76, this.topPos + 107, 16, 16, 0, 0, 16, new ResourceLocation("deathnote:textures/screens/atlas/imagebutton_6obsession.png"), 16, 32, e -> {
			if (true) {
		...
		imagebutton_1ghostly_hunger3 = new ImageButton(this.leftPos + 47, this.topPos + 98, 16, 16, 0, 0, 16, new ResourceLocation("deathnote:textures/screens/atlas/imagebutton_1ghostly_hunger3.png"), 16, 32, e -> {
			if (true) {
