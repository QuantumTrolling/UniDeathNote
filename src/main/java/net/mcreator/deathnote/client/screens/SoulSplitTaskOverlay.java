...
public class SoulSplitTaskOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (ShowSoulSplitTaskProcedure.execute(entity)) {
			...
			event.getGuiGraphics().drawString(Minecraft.getInstance().font, Component.translatable("gui.deathnote.soul_split_task.label_siest_ghniluiu_plot"), posX + -234, posY + -103, -1, false);
		}
	}
}
