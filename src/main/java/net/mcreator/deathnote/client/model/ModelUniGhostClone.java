package net.mcreator.deathnote.client.model;
...
public class ModelUniGhostClone<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("deathnote", "model_uni_ghost_clone"), "main");
	...
	public ModelUniGhostClone(ModelPart root) {
